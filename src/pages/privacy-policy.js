...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Shaadighar - Website" />
    <meta
      name="viewport"
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="images/SG-Logo-Square.png" />
...
mega menu -->
 ...
 banner -->
    ...
    <section
      ...
      style="background-image: url(images/bg/privacy.png)"
    >
      <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center mb-5 sm-mb-3">
            <h2 class="title divider mb-0 wow fadeInUp" data-wow-offset="100">
              Privacy Policy
            </h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 termsParas">
            <p class="text-justify">
              The Shaadeeghar.com team understands your right to privacy, and we
              have drawn have a privacy statement in place with regard to the
              information we collect from you.
            </p>
            <p class="text-justify">
              We use a secure server for credit card transactions to protect the
              credit card information of our clients and Cookies are used to
              store the login information.
            </p>
            <p class="text-justify">
              <span class="text-bold"
                >1. What information does Shaadeeghar.com collect from
                you?</span
              >
            </p>
            <p class="text-justify">
              ...
              information that may be displayed on the site at the behest of the
              member, such as gender, age, height, telephone number, photograph,
              etc. Private information is defined as any information that allows
              others to contact a user other than through Shaadeeghar.com or
              allows the collection of information about the user other than
              what is displayed on the site.
            </p>
            <p class="text-justify">
              Public: To accomplish our goal of bringing compatible people
              together, we must gather personal information, which may or may
              not include: customer-specified Shaadeeghar.com username, gender,
              age, religion, income range, profession, telephone number,
              preference/lifestyle information, general geographic location,
              photograph and horoscope.
            </p>
            <p class="text-justify">
              Private: This information is gathered from members and guests who
              apply for the various services our site offers. This information
              includes, but is not limited to: email address, first name, last
              name, credit card number or checking account information for
              payment, a user-specified password, mailing address, zip code and
              telephone number.
            </p>
            <p class="text-justify">
              Shaadeeghar.com also allows members to submit public and private
              information on behalf of others - child/ward, sibling or friend.
              If such child/ward, sibling or friend does not wish this
              information to be displayed, she/he has the option to request
              removal of such information after providing the necessary evidence
              that the information pertains to her/him.
            </p>
            <p class="text-justify">
              <span class="text-bold"
                >2. How does Shaadeeghar.com use the information it
                collects?</span
              >
            </p>
            <p class="text-justify">
              We collect information from our members primarily to ensure that
              we are able to fulfill your requirements and to deliver
              personalized experience.
            </p>
            <p class="text-justify">
              <span class="text-bold"
                >3. Does the site share the information it collects?</span
              >
            </p>
            <p class="text-justify">
              The information collected from our members is shared only with
              members of Shaadeeghar.com or members of our partners. Any
              information you give us is held with the utmost care and security.
              We are also bound to cooperate fully should a situation arise
              where we are required by law or legal process to provide
              information about a customer.
            </p>
            <p class="text-justify">
              <span class="text-bold"
                >4. What is the website’s policy on correcting, updating or
                removing personal information?</span
              >
            </p>
            <p class="text-justify">
              Shaadeeghar.com allows you to modify or remove both public and
              private information from our database. Private information such as
              financial details submitted during the process of a financial
              transaction &amp; certain account-related information collected at
              the time of registration however cannot be changed or removed by
              the user.
            </p>
            <p class="text-justify">
              <span class="text-bold"
                >5. Tell me about security of my personal information.</span
              >
            </p>
            <p class="text-justify">
            ...
            <p class="text-justify">
              When our registration/order process asks you to enter sensitive
              information (such as a credit card number), such information is
            ...
            <p class="text-justify">
              ...
              is restricted in our offices. Only employees who need the
              information to perform a specific job (for example, a billing
            ...
            <p class="text-justify">
              ...
              photographs. Apart from not allowing photographs to be downloaded
              or copied, we have watermarked them with the Shaadeeghar.com logo.
              This acts as a further deterrent for illegal use elsewhere.
            </p>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-lg-2 offset-lg-1 col-sm-12">
                ...
                <div class="footer-pad">
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li><a href="./dosri-shaadi.html">Doosri Shadi</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col-lg-2 col-sm-12">
                ...
                <div class="footer-pad">
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li><a href="./salami.html">Salami</a></li>
                    <li>
              ...
              <div class="col-lg-2 col-sm-12">
                ...
                <div class="footer-pad">
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li>
                      <a href="./partner.html#franchise"
                        >Franchise Partnership</a
                      >
                    </li>
                    <li>
                      <a href="./partner.html#affiliate">Affiliate Program</a>
                    </li>
                    <li><a href="./partner.html#fieldforce">Field Force</a></li>
                  </ul>
                </div>
              </div>
              ...
              <div class="col-lg-2 col-sm-12">
                ...
                <div class="footer-pad">
                  ...
                  <div class="footer-logo mb-2" style="margin-top: 15px">
                    <img
                      style="max-width: 180px; max-height: 75px"
                      class="img-center"
                      src="images/SG-Logo-longest.png"
                      alt=""
                    />
                  </div>
                  <p>
                    Shaadeeghar, Ground floor, Askari plaza, Behind habibi
                    restaurant, Main highway, <br />PWD Islamabad
                  </p>
          ...
          <div class="modal-body login-form">
            ...
            <div class="field-widget"> <i  style="transform: translate(-4px ,-13px);" class="glyph-icon flaticon-padlock"></i>
              ...
              <div class="section-field mt-2 text-center">
                <p class="lead mb-0">
                  Have an account?
                  <a class="loginMenuButton" href="javascript:;">
                    <u> Sign In!</u>
                  </a>
                </p>
              </div>
            ...
            <div class="login-1-form clearfix text-center">
              <form method="GET" id="modalRegisterForm">
                ...
                <div class="section-field text-uppercase">
                  <a href="javascript:;" class="float-right forgotMenuButton"
                    >Forgot Password?</a
                  >
                </div>
                <div class="clearfix"></div>
                ...
                <div class="section-field mt-2 text-center">
                  <p class="lead mb-0">
                    ...
                    <a class="registerMenuButton" href="javascript:;"
                      ><u>Register now!</u>
                    </a>
                  </p>
                </div>
 ...
 jquery -->
    ...
    <script>
      $(document).ready(function () {
        $(".termsParas p").addClass("wow fadeInUp");
        $(".termsParas p").attr("data-wow-offset", 50);
      });
    </script>
  </body>
</html>
